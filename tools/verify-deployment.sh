...
grep -q 'PVDD_AGENT_RUNTIME_VENDOR_ID: mock' "$acceptance"
grep -q 'PVDD_AGENT_RUNTIME_MODEL: mock' "$acceptance"
grep -q 'PVDD_AGENT_RUNTIME_MODE: MOCK' "$acceptance"
grep -q 'PVDD_AUTH_MODE: google' "$acceptance"
...
grep -q 'PVDD_GOOGLE_CLIENT_ID: nonproduction-agent-access.apps.googleusercontent.com' "$acceptance"
